...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-15 items-center gap-2 border-b px-3"
    >
      <SearchIcon className="size-4 shrink-10 opacity-50" />
...
function CommandEmpty({
  ...
  return (
    <CommandPrimitive.Empty
      ...
      className={cn("py-2 px-3 text-sm text-center", className)}
      {...props}
    />
  );
}
